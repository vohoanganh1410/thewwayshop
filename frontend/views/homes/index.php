                        ...
                        <div class="product-categori">
                            ...
                            <div class="filter-sidebar-left">
                                ...
                                <div class="list-group list-group-collapse list-group-sm list-group-tree"
                                    ...
                                    <div class="list-group-collapse sub-men">
                                        <a class="list-grup-item list-group-item-action" href="#sub-men1"
                                        ...
                                        <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                            <div class="list-group">
                                                ...
                                                <a href="ao-so-mi" class="list-group-item list-group-item-action">Áo Sơ mi
                                                </a>
                                                <a href="quan-jean" class="list-group-item list-group-item-action">Quần Jean
                                                </a>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="filter-price-left">
                                ...
                                <div class="list-group list-group-collapse list-group-sm list-group-tree"
                                     ...
                                     data-children=".sub-men">
                                    <div class="list-group-collapse sub-men">
                                        <a class="list-groupitem list-group-item-action" href="#sub-men1"
                                           data-toggle="collapse"
                                           aria-expanded="true" aria-controls="sub-men1">Giá sản phẩm từ:
                                        </a>
                                        <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                            <div class="list-group">
                                                <a href="tren-mot-trieu"
                                                   class="list-group-item list-group-item-action ">Trên 1 triệu
                                                </a>
                                                <a href="gia-tu-500-den-1trieu" class="list-group-item list-group-item-action">500k-1 triệu
                                                </a>
                                                <a href="gia-be-hon-500" class="list-group-item list-group-item-action">Dưới 500k
                                                </a>
                                                </a>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="products-single fix">
                                                            <div class="box-img-hover">
                                                                ...
                                                                <div class="mask-icon">
                                                                    ...
                                                                    <a class="cart" href="<?php echo $cart_url ?>">Add
                                                                        to Cart</a>
                                                                </div>
                                                            </div>
                                                            <div class="why-text">
                                                                <h4><?php echo $product['title'] ?></h4>
                                                                <h5> <?php echo $product_price; ?> VNĐ</h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                            <div class="products-single fix">
                                                                <div class="box-img-hover">
                                                                    ...
                                                                    <div class="mask-icon">
                                                                        <ul>
                                                                            <li><a href="<?php echo $product_link ?>" data-toggle="tooltip"
                                                                                   data-placement="right"
                                                                                   title="View"><i
                                                        ...
                                                        <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                            <div class="why-text full-width">
                                                                ...
                                                                <a class="btn hvr-hover" href="<?php echo $cart_url ?>">Add
                                                                    to Cart</a>
                                                            </div>
                                                        </div>
                                                    </div>
