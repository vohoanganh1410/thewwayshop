...
//        1 - chuẩn bị truy vấn
        $obj_select = $this->connection
            ->prepare("SELECT products.*  ,
                      ...
                      categories.status AS category_status
                      FROM products 
 INNER JOIN  categories ON products.category_id = categories.id where title like '%áo khoác%' ");
...
//        1 - chuẩn bị truy vấn
        $obj_select = $this->connection
            ->prepare("SELECT products.*  ,
                      ...
                      categories.status AS category_status
                      FROM products 
 INNER JOIN  categories ON products.category_id = categories.id where title like '%áo sơ mi%' ");
...
//        1 - chuẩn bị truy vấn
        $obj_select = $this->connection
            ->prepare("SELECT products.*  ,
                      ...
                      categories.status AS category_status
                      FROM products 
 INNER JOIN  categories ON products.category_id = categories.id where title like '%quần jean%' ");
...
//        1 - chuẩn bị truy vấn
        $obj_select = $this->connection
            ->prepare("SELECT products.*  ,
                      ...
                      categories.status AS category_status
                      FROM products 
 INNER JOIN  categories ON products.category_id = categories.id where price<500000 ");
...
//        1 - chuẩn bị truy vấn
        $obj_select = $this->connection
            ->prepare("SELECT products.*  ,
                      ...
                      categories.status AS category_status
                      FROM products 
 INNER JOIN  categories ON products.category_id = categories.id where price>=500000 and price<1000000");
...
//        1 - chuẩn bị truy vấn
        $obj_select = $this->connection
            ->prepare("SELECT products.*  ,
                      ...
                      categories.status AS category_status
                      FROM products 
 INNER JOIN  categories ON products.category_id = categories.id where price>=1000000");
    ...
    public function timkiem($key){
        $obj_select = $this->connection
            ->prepare("SELECT products.*  ,
                      ...
                      categories.status AS category_status
                      FROM products 
 INNER JOIN  categories ON products.category_id = categories.id where title REGEXP '' ORDER BY id DESC ");
